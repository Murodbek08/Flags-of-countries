...
function renderPaginationButtons() {
  ...
  pagination.innerHTML += `<button onclick="paginationItemBack()"> 
    <img src="../images/chevron-left.svg" alt="Chevron icon">
  </button>`;
  ...
  pagination.innerHTML += `<button onclick="paginationItemNext()"> 
    <img src="../images/chevron-right.svg" alt="Chevron icon">
  </button>`;
}
